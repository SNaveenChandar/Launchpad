		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "CHS Launchpad",
									"targetURL": "#comchslaunchpad-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comchslaunchpad-display": {
								"semanticObject": "comchslaunchpad",
								"action": "display",
								"description": "CHS Launchpad",
								"title": "CHS Launchpad",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.chs.launchpad",
									"url": sap.ui.require.toUrl("com/chs/launchpad")
								}
							}
						}
					}
