sap.ui.define([
    ...
    function (Controller, mobileLibrary, JSONModel) {
        ...
        const Apps = {
	        ...
	        "RFS2Specific": [
				{ 
				  "applicationName": "Maintain RFS2 Material", 
			...
			"Technical": [
				{
					...
					"url": "https://chsincdev.launchpad.cfapps.us10.hana.ondemand.com/13ef1f34-3934-496c-b566-7bff95a56f20.comchssapzcom_mtnregtyp.zfemtnregtyp-0.0.1"
				},
				{
					"applicationName": "Maintain Transaction Type",
					"url": "https://chsincdev.launchpad.cfapps.us10.hana.ondemand.com/d5d3580a-fdb3-4eb7-a201-352849fbb317.comchssapzcom_mtntxntyp.zfemtntxntyp-0.0.1"
				},
				{
				...
				{
					"applicationName": "Maintain Action Sub-Scenario Assignment",
				...
				{
					"applicationName": "Maintain Sub-scenario to Scenario Assignment",
			...
			},
			{
				...
				"applicationName": "Maintain Regulation Transaction Type with impact",
				...
				"applicationName": "Maintain Incoterms Impact For Import / Export",
				"url": "https://chsincdev.launchpad.cfapps.us10.hana.ondemand.com/5fadc9bd-38f8-4ef8-bc32-d9ac4d06cdbe.comchssapzcom_mtnitimp4imptotexpt.zfemtnitimp4imptotexpt-0.0.1"
